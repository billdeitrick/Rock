namespace Rock.Plugin.HotFixes
{
    ...
    public class AddObsidianGroupScheduler : Migration
    {
        ...
        private void AddObsidianGroupScheduler_AddPublicBlockTypes()
        {
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "511D8E2E-4AF3-48D8-88EF-2AB311CD47E0", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Roster Page", "RosterPage", "Roster Page", "Page used for viewing the group schedule roster.", 3, "", "BE034EB3-1D5B-43D6-A8EB-CEF569700922" );
        }
        ...
        private void ShortTermServingProjects_DeletePublicBlockTypes()
        {
            ...
            RockMigrationHelper.DeleteAttribute( "BE034EB3-1D5B-43D6-A8EB-CEF569700922" );
