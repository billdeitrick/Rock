...
namespace Rock.ViewModels.Blocks.Crm.FamilyPreRegistration
{
    ...
    /// </summary>
    public class FamilyPreRegistrationGetScheduleDatesResponseBag
    {
        public string ErrorTitle { get; set; }

        public string ErrorText { get; set; }

        public bool? IsPlannedDatePanelHidden { get; set; }

        public bool? IsPlannedSchedulePanelHidden { get; set; }

        public List<FamilyPreRegistrationScheduleDateBag> ScheduleDates { get; set; }
    }
}
