...
namespace Rock.ViewModels.Blocks.Group.Scheduling.GroupScheduler
{
    ...
    public class GroupSchedulerCloneSchedulesResponseBag
    {
        ...
        /// <summary>
        /// Gets or sets the explanation for any resources that were skipped during the cloning attempt.
        /// </summary>
        /// <value>
        /// The explanation for any resources that were skipped during the cloning attempt.
        /// </value>
        public string SkippedResourcesExplanation { get; set; }
    }
}
